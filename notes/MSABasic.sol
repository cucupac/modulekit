...
contract MSABasic is IMSA, ExecutionHelper, ModuleManager {
     ...
     */
    // NOTE: this is called by the entry point
    //       long story short: it calles _execute
    function execute(
        ModeCode mode,
    ...
    // NOTE: this is called by an executor module
    //       long story short: it calles _execute
    // NOTE: simply: is message.sender in the list?
    ...
    // NOTE: only the entry point can call this
    //       it then calls a function on this contract (probably execute())
    //       it's for cases where the account needs something in a userOp
    ...
    // NOTE: this is standard and an example can be found in the account-abstraction repository.
        ...
        returns (uint256 validSignature)
    {
        ...
        // NOTE: sending in address as nonce. What's to protect against replay attacks?
        // QUESTION: Are nonces stored on entry points?
